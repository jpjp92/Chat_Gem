...
#         return False, f"이미지 크기가 너무 큽니다. 최대 크기: 10MB, 현재 크기: {uploaded_file.size / (1024*1024):.1f}MB"
...
#                 key=f"chat_image_uploader_{st.session_state.uploader_key}",  # 동적 key
...
#                 key=f"chat_pdf_uploader_{st.session_state.uploader_key}",  # 동적 key
